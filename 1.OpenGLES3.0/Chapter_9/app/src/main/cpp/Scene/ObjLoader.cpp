...
#else
    strcpy( fname, "/storage/emulated/0/Android/data/cookbook.opengles_9/files/" );
#endif
...
void ObjLoader::InitModel()
{
    ...
    NormalTransform  = ProgramManagerObj->ProgramGetUniformLocation(program, (char*)"NormalTransform");
...
void ObjLoader::Render()
{
    ...
    glUniformMatrix3fv( NormalTransform, 1, GL_FALSE, (float*)&normalTransform );
