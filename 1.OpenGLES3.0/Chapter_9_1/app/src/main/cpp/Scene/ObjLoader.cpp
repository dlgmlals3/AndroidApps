...
#else
    strcpy( fname, "/storage/emulated/0/Android/data/cookbook.opengles_9_1/files/" );
#endif
...
void ObjLoader::InitModel()
{
    ...
    if ( LightPosition >= 0 ){
        glm::vec3 lightPosition(0.0, 2.0, 0);
...
void ObjLoader::Render()
{
	...
	TransformObj->TransformRotate(rot++ , 1.0, 1.0, 1.0); // dlgmlals3
